...
export default function Edit({ auth, job_vacancy }) {
    ...
    // inisialisasi dengan data 'job_vacancy' dari controller.
    ...
    // [3] Fungsi submit sekarang mengirim request PUT nyata ke server
    const submit = (e) => {
        e.preventDefault();
        // Method put() akan mengirim data ke rute 'update' dengan ID yang sesuai
        put(route("admin.job_vacancies.update", job_vacancy.id));
    };
